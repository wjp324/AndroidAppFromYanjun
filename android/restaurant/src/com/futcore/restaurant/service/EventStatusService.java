package com.futcore.restaurant.service;
            ...
            for(ManEvent cevent:eventModel){
                ...
                countdowns.add(new CountDownTimer(ccdate, 1000) {
                        public void onTick(long millisUntilFinished) {
                            System.out.println("iiiiiiiiiiddddddddddddddddddddddddd"+startId);
                            ...
                            if(millisUntilFinished+1<30){
                                //                                sendNotification(eveTitle, String.format("%02d:%02d:%02d", millisUntilFinished / 3600,(millisUntilFinished % 3600) / 60, (millisUntilFinished % 60))+" left.", NOTI_DANGER);
                                sendNotification(eveTitle, oriSec, NOTI_NORMAL);
