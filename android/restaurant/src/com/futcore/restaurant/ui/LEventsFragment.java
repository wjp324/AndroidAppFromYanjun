...
public class LEventsFragment extends SherlockFragment implements OnClickListener
{
    ...
    MusicSectionListFragment sectList = null;
    ...
    */
    ...
    public static LEventsFragment newInstance() {
        LEventsFragment fragment = new LEventsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle state){
        ...
        mView = inflater.inflate(R.layout.levents, parent, false);

        sectList = new MusicSectionListFragment();

        FragmentTransaction transaction1 = getChildFragmentManager().beginTransaction();
        transaction1.add(R.id.musicSectionsList, sectList).commit();

        //terry work arround to avoid Preference context error
        new android.os.Handler().
            postDelayed(
                        new Runnable() {
                            public void run() {
                                sectList.refreshEvents();
