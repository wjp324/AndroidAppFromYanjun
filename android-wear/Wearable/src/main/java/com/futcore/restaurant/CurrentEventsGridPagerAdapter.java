...
public class CurrentEventsGridPagerAdapter extends FragmentGridPagerAdapter {

    private final Context mContext;

    public CurrentEventsGridPagerAdapter(Context ctx, FragmentManager fm) {
        super(fm);
        mContext = ctx;
    }
    ...
    public Fragment getFragment(int row, int col) {
        ...
        CEventsListFragment eventList = new CEventsListFragment();

        return eventList;

        ///        return (Fragment) eventList;
