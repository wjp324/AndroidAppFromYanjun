...
public class ManEvent implements java.io.Serializable {
	...
	public ManEvent(String eventId, ManUser manUser, ManItem manItem, int eventScore, double eventComplete, double eventLat, double eventLng, int contDay, Date createTime, Date startTime, Date updateTime, Date estEndTime, int estDuration, byte isDelete) {
        this.eventId = eventId;
		this.manUser = manUser;
		this.manItem = manItem;
		this.eventScore = eventScore;
