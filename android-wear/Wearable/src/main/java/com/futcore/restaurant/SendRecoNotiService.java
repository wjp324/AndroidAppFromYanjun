...
public class SendRecoNotiService extends Service
{
    ...
    private void sendRecoNotification(String title, int type)
    {
        ...
        mRecoBuilder.setContentTitle(title);
            //            .setContentText(Integer.toString(recoScore)+"   "+secToHhMmSs(riw.getRecoDuration()));
    ...
    private Notification addAllRecoPages()
    {
        ...
        for(ManRecoItemWearWithScore riw:curRecoItemWearScoreModel){
            ...
            Notification secondPageNotification =
                ...
                //                .setContentText(Integer.toString(recoScore)+"   "+secToHhMmSs(riw.getRecoDuration()))
                .setContentTitle(Integer.toString(recoScore)+"   "+secToHhMmSs(riw.getRecoDuration()))
                .setContentText(riw.getManItem().getItemName())
                //                .setContentText("Test")
                //                .setUsesChronometer(true)
                .setOngoing(true)            
        ...
        for(Notification noti:nlist){
            ...
            intent.putExtra("recowear", (ManRecoItemWear)curRecoItemWearScoreModel.get(j++));
    ...
    private void updateRecoItemWearModel()
    {
        ...
        try{
            ...
            System.out.println("llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllooooo");
            ...
            Intent intent1 = new Intent(this, SendForceRecoNotiService.class);
