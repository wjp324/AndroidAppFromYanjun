...
public class ConfirmForceRecoActivity extends Activity implements DelayedConfirmationView.DelayedConfirmationListener{
    ...
    public void onTimerFinished(View v) {
        ...
        if(!mIsCancel){
            ...
            try{
                ...
                eventWearDao.create(new ManEventWear(ItemIdUtil.getGenId("event"), tuser, mRecoWear.getManItem(),0,0,0,curTime, curTime+mRecoWear.getRecoDuration()*1000,mRecoWear.getRecoDuration()/60, (byte)0));
